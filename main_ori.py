...
val_data = pd.read_table('E:/data/oppo_ogeek_query_match/oppo_round1_vali_20180929.txt',names=['prefix','query_prediction','title','tag','label'],header=None,encoding='utf-8').astype(str)
test_data = pd.read_table('E:/data/oppo_ogeek_query_match/oppo_round1_test_A_20180929.txt',names=['prefix','query_prediction','title','tag','label'],header=None,encoding='utf-8').astype(str)
...
a['label3'] = numall
a['label3'].to_csv('./result.csv',index=False)